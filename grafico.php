<html>
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ...
            <?php
              ...
              // Consulta o total de alunos em cada curso
              $sql = "SELECT escolaridademae, COUNT(*) AS quantidade, CONCAT(FORMAT(COUNT(*) * 100 / SUM(COUNT(*)) OVER(), 2), '%') AS porcentagem FROM form3 GROUP BY escolaridademae; ";
              $result = mysqli_query($mysqli, $sql);
  ...
  <header>
   ...
   <tbody>
    ...
    <tr>   
<td id="linha">
    <div id="columnchart_material02" style="width: 600px; height: 350px;"></div> 
</td>
<td id= "linha" >
    <div id="columnchart_material03" style="width: 580px; height: 350px;"></div>
</td>
    </tr>
   </tbody>
    </table>
    ...
    <section class="bcgb">
            ...
            <br>
            <p id="cnt2"></p>
            <h1 id="cnt">Escolaridade dos Pais</h1>
            <br>
            <br>
            <br>
            <br>
   ...
   <tbody>
    ...
    <tr>   
<td id="linha">
    <div id="columnchart_material04" style="width: 600px; height: 350px;"></div> 
</td>
<td id= "linha" >
    <div id="columnchart_material05" style="width: 580px; height: 350px;"></div>
</td>
    </tr>
   </tbody>
    </table>
    ...
    <section class="bcgb">
            ...
            <br>
            <p id="cnt2"></p>
            <h1 id="cnt">Residência do aluno</h1>
            <br>
            <br>
            <br>
            <br>
   ...
   <tbody>
    ...
    <tr>   
<td id="linha">
    <div id="columnchart_material06" style="width: 600px; height: 350px;"></div> 
</td>
<td id= "linha" >
    <div id="columnchart_material07" style="width: 580px; height: 350px;"></div>
</td>
    </tr>
   </tbody>
    </table>
   ...
   <tbody>
    ...
    <tr>   
<td id="linha">
    <div id="columnchart_material08" style="width: 600px; height: 350px;"></div> 
</td>
<td id= "linha" >
    <div id="columnchart_material09" style="width: 580px; height: 350px;"></div>
</td>
    </tr>
   </tbody>
    </table>
